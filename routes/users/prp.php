...
Route::get('prp/feedbacked_leave_request/{user_id}','Requests\LeaveRequestController@getAllFeedbackedRequest')->name('prp.get_all_feedbacked_leave_request');

// get all approved leave request that belongs of approver
Route::get('prp/approved_leave_request/{user_id}','Requests\LeaveRequestController@getAllApprovedRequest')->name('prp.get_all_approved_leave_request');

// get all disapproved leave request that belongs of approver
Route::get('prp/disapproved_leave_request/{user_id}','Requests\LeaveRequestController@getAllDisapprovedRequest')->name('prp.get_all_disapproved_leave_request');
