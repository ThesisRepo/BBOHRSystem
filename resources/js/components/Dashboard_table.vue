<template>
  ...
  class="elevation-1">
    ...
    <v-toolbar class="mb-2" color="blue darken-1" dark flat>
      <v-toolbar-title class="col pa-3 py-4 white--text" style="font-size:16px">{{ !isGenManager ? 'MY PENDING REQUESTS' : 'PENDING EMPLOYEE REQUESTS'}}</v-toolbar-title>
    </v-toolbar>
    </template>
    ...
    <template v-if="isGenManager" v-slot:item.user="{ item }">
...
import {hasGeneralManager} from '../helpers/user_roles.js'
export default {
  data: () => ({
