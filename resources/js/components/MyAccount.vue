            ...
            <v-col>
                <v-card class="mx-auto pa-2 ">
                    ...
                    <v-row>
                        ...
                        <v-col>
                            <h1
                                class="title-h3 text-md-h3 text-sm-h3 text-truncate mt-8"
                            >
                                {{ user_name }}
                            </h1>
                            <h2
                                class="title-h5 text-md-h5 text-sm-h5 text-truncate"
                            >
        ...
        getInfo() {
            this.$axios
                ...
                .then(response => {
                    ...
                    this.company_status =
                        response.data.user_information.company_status;
                    this.profile_url =
                        response.data.user_information.profile_url;
                    this.birthdate = response.data.user_information.birthday;
                    this.contact_number =
                        response.data.user_information.contact_number;
                    this.pag_ibig =
                        response.data.user_information.pag_ibig_number;
