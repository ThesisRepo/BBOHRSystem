...
<v-row justify="center">
    <v-dialog v-model="dialog" persistent max-width="600px">
        <template v-slot:activator="{ on, attrs }">
            <v-btn color="light blue darken-2" rounded outlined dark v-bind="attrs" v-on="on" @click="removeData()">
        ...
        <v-card>
            ...
            <v-card-text>
                <v-container>
                    ...
                    <v-row>
                        <v-col cols="12" md="6">
                            <v-select :items="leaveType" label="Reason*" v-model="selectedLeaveType" item-text="name" item-value="value" required></v-select>
                        </v-col>
                        <v-col cols="12" md="6">
                        ...
                        <v-col cols="12" md="6">
                            <v-text-field label="End Date & Time" id="enable" type="datetime-local" :allowed-dates="disabledDates2" v-model="end_date" @change="changeDate()"></v-text-field>
                            <span v-if="error1" class="ml-7" style="color: red; font-size: 13px">Higher the End Date</span>
                        </v-col>
                        <v-col cols="12" md="6">
                            <v-text-field label="Total Day/s of Leave*" type="text" v-model="total_days_with_text" disabled></v-text-field>
                        </v-col>
                        <!-- <v-col cols="12" >
