<template>
  <v-row justify="center">
    <v-dialog v-model="dialogPersonal" show-overlay persistent max-width="600px">
      ...
      <v-card>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="red" dark @click="dialogPersonal = false">Cancel</v-btn>
          <v-btn color="blue darken-1" dark @click="next()">Next</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
    <!-- End of Personal******************************************************************* -->
    <v-dialog v-model="dialogBusiness" persistent max-width="600px">
      <v-card>
        ...
        <v-card-actions>
          <v-btn color="blue darken-1" dark style="float-left" @click="backPersonal()">
            <v-icon>mdi-arrow-left-bold</v-icon>Back
          </v-btn>
          <v-spacer></v-spacer>
          <v-btn color="blue darken-1" dark @click="next1()">
            <v-icon>mdi-arrow-right-bold</v-icon>Next
          </v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
    ...
    <v-dialog v-model="dialogOthers" persistent max-width="600px">
      <v-card>
        ...
        <v-card-actions>
          <v-btn color="blue darken-1" dark style="float-left" @click="backBusiness()">
            <v-icon>mdi-arrow-left-bold</v-icon>Back
          </v-btn>
          <v-spacer></v-spacer>
          <v-btn color="blue darken-1" dark @click="addNew()">Save</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
    ...
    validate(input) {
      ...
      if (input === "firstname") {
        ...
        if (!numberExclude.test(this.contact_number)) {
          ...
          this.errorMessage6 = "Contact number must not exceed 11 numbers";
        ...
        if (this.validateEmail(this.email) === false) {
          ...
          this.errorMessage8 = "Emailsss is required";
        } else {
          this.errorMessage8 = null;
        }
        ...
        } else if (this.company_id.length < 11) {
        ...
        if (this.sss_number.length > 10) {
          this.errorMessage20 = "SSS number must be 12 digit number";
        ...
        if (this.tin_number.length > 9) {
          this.errorMessage22 = "TIN number must be 9 digit number";
        } else if (this.tin_number.length == 0) {
          this.errorMessage23 = "TIN number is required";
        } else if (this.tin_number.length < 9) {
          this.errorMessage23 = "TIN number is invalid";
        } else {
          this.errorMessage22 = null;
          this.errorMessage23 = null;
        }
        ...
        if (this.tin_number.length > 12) {
          this.errorMessage24 = "PhilHealth number must be 9 digit number";
        } else if (this.tin_number.length == 0) {
          this.errorMessage25 = "TIN number is required";
        } else if (this.tin_number.length < 12) {
          this.errorMessage25 = "TIN number is invalid";
        } else {
          this.errorMessage24 = null;
          this.errorMessage25 = null;
        }
