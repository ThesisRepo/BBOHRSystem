...
class AllUserRequestsService 
{
  ...
  public function getGMAllToApprove($with) {
    ...
    return $this->array_push(...$leave_request, ...$shift_change_request, ...$overtime_request,...$budget_request, ...$petty_cash_request, ...$travel_auth_request); 
  }
  ...
  public function array_push(...$array) {
    try {
      return $array; 
    }catch(\Exception $e ) {
      return $e;
